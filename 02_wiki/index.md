...
> Minimal catalogue of the public sample vault.
> The goal is to show the method, not to replicate the full working corpus.

## Fuentes

- [[karpathy-llm-wiki|Karpathy — LLM Wiki (2026)]] — Architectural pattern for compiling personal knowledge bases with LLMs. `firme` · `ia`
- [[azaustre-segundo-cerebro|Azaustre — Segundo cerebro Karpathy (2026)]] — Operational implementation with automation, lint, and output feedback loops. `firme` · `ia`
...
- [[criterio-vs-acceso|Criterio vs acceso]] — The first wave solved discovery; the next one must solve judgement. `firme` · `ia`
...
- [[ateneo-kb-public|Ateneo-KB Public]] — Public edition of the editorial knowledge base method. `firme` · `ateneo | ia`
